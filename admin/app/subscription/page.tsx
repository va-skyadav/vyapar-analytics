...
export default function Subscription(){
 ...
 const editOffer=(o:Offer)=>{setOfferEditorOpen(true);setEditingOffer(o);setOfferForm({code:o.code,name:o.name,description:o.description||"",offer_type:o.offer_type,discount_type:o.discount_type,discount_value:String(o.discount_value??0),buy_quantity:String(o.buy_quantity??2),free_quantity:String(o.free_quantity??1),trial_days:String(o.trial_days??14),credit_amount:String(o.credit_amount??0),starts_at:o.starts_at?o.starts_at.slice(0,16):"",ends_at:o.ends_at?o.ends_at.slice(0,16):"",max_redemptions:o.max_redemptions?String(o.max_redemptions):"",max_redemptions_per_customer:String(o.max_redemptions_per_customer??1),first_time_only:o.first_time_only,auto_apply:o.auto_apply,stackable:o.stackable,is_active:o.is_active});};
 const newOffer=()=>{setEditingOffer(null);setOfferEditorOpen(true);setOfferForm({...blankOffer});};
