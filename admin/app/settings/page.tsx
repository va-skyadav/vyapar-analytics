  ...
  {loading?<div className="card">Loading platform controls...</div>:<>
   <div className="settingsHeaderBar">
    <div className="settingsTabs" role="tablist">
     ...
     <button className={activeTab==="billing"?"settingsTab active":"settingsTab"} onClick={()=>setActiveTab("billing")}>Billing</button>
   ...
   {activeTab==="configuration"&&<div className="statsRow settingsKpis">
